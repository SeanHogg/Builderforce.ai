...
function VideoPreview({ frames, videoUrl, width, height, loading }) {
  ...
  return /* @__PURE__ */ jsxs3("div", { children: [
    /* @__PURE__ */ jsx3("div", { className: "bfs-preview", style: { aspectRatio: `${width} / ${height}` }, children: loading ? /* @__PURE__ */ jsx3(LoadingState, { ...loading }) : videoUrl ? /* @__PURE__ */ jsx3("video", { ref: videoRef, src: videoUrl, controls: true, autoPlay: true, loop: true, className: "bfs-preview-video" }) : /* @__PURE__ */ jsx3("div", { className: "bfs-preview-empty", children: "Enter a prompt and press Generate." }) }),
    !loading && videoUrl && thumbUrls.length > 0 ? /* @__PURE__ */ jsx3(
      "div",
      {
...
function LoadingState({
  ...
  return /* @__PURE__ */ jsxs3(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx3("div", { style: { fontSize: "0.85rem", textAlign: "center", opacity: 0.85 }, children: label }),
        /* @__PURE__ */ jsx3(
          "div",
          {
            style: {
        ...
        /* @__PURE__ */ jsxs3("div", { className: "bfs-mono", style: { fontSize: "0.75rem", opacity: 0.7 }, children: [
          framesDone,
          " / ",
          framesTotal,
          " frames"
...
function DebugCopyButton(props) {
  ...
  const [errorMsg, setErrorMsg] = useState2(null);
...
function EffectiveChainBadge(props) {
  ...
  return /* @__PURE__ */ jsxs5(
    "p",
    {
      ...
      children: [
        /* @__PURE__ */ jsx6("strong", { children: "Effective model chain:" }),
        " ",
        /* @__PURE__ */ jsx6("span", { className: "bfs-mono", children: describeChain(chain) }),
        chain.overridesQuality ? /* @__PURE__ */ jsxs5(Fragment2, { children: [
          " ",
...
function QualityTierPicker({ value, onChange, disabled }) {
  ...
  return /* @__PURE__ */ jsxs5("div", { className: "bfs-field", children: [
    /* @__PURE__ */ jsx6("label", { className: "bfs-label", children: "Quality" }),
    /* @__PURE__ */ jsx6("div", { className: "bfs-radio-row", children: QUALITY_TIERS.map((tier) => {
    ...
    /* @__PURE__ */ jsx6("p", { className: "bfs-hint", children: current.description })
  ] });
}
...
function StoryboardEditor({
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "bfs-field", style: { border: "1px solid var(--bfs-border)", borderRadius: 8, padding: 12 }, children: [
    ...
    /* @__PURE__ */ jsxs6("div", { style: { marginTop: 8 }, children: [
      /* @__PURE__ */ jsxs6("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
        /* @__PURE__ */ jsx7("span", { className: "bfs-label", children: "Cast" }),
        /* @__PURE__ */ jsx7(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ jsx7("div", { style: { display: "flex", flexDirection: "column", gap: 6, marginTop: 4 }, children: characters.map((c, i) => /* @__PURE__ */ jsxs6("div", { className: "bfs-row", style: { alignItems: "center" }, children: [
        /* @__PURE__ */ jsx7(
          "input",
          {
            className: "bfs-input",
    ...
    /* @__PURE__ */ jsx7("div", { style: { display: "flex", flexDirection: "column", gap: 10, marginTop: 10 }, children: shots.map((shot, idx) => {
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs6("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
              ...
              /* @__PURE__ */ jsx7("button", { type: "button", className: "bfs-btn bfs-btn-secondary", onClick: () => moveShot(idx, -1), disabled: busy || idx === 0, title: "Move up", style: { fontSize: "0.75rem", padding: "2px 6px" }, children: "\u2191" }),
              /* @__PURE__ */ jsx7("button", { type: "button", className: "bfs-btn bfs-btn-secondary", onClick: () => moveShot(idx, 1), disabled: busy || idx === shots.length - 1, title: "Move down", style: { fontSize: "0.75rem", padding: "2px 6px" }, children: "\u2193" }),
              /* @__PURE__ */ jsx7("button", { type: "button", className: "bfs-btn bfs-btn-secondary", onClick: () => removeShot(idx), disabled: busy, title: "Delete shot", style: { fontSize: "0.75rem", padding: "2px 6px" }, children: "\u2715" })
            ] }),
            /* @__PURE__ */ jsx7(
              "textarea",
              {
            ...
            characters.length > 0 && /* @__PURE__ */ jsx7("div", { style: { display: "flex", flexWrap: "wrap", gap: 8 }, children: characters.map((c) => /* @__PURE__ */ jsxs6("label", { style: { display: "flex", alignItems: "center", gap: 4, fontSize: "0.75rem", cursor: "pointer" }, children: [
              /* @__PURE__ */ jsx7(
                "input",
                {
                  type: "checkbox",
...
function useEngineStatus() {
  const [status, setStatus] = useState3({ state: "probing" });
...
function StudioPanel({
  ...
  const [coherenceStrength, setCoherenceStrength] = useState4(0.5);
  const [motionAmount, setMotionAmount] = useState4(0.15);
  const [imgToImgStrength, setImgToImgStrength] = useState4(0);
  const [anchorRefreshInterval, setAnchorRefreshInterval] = useState4(0);
  const [cameraDx, setCameraDx] = useState4(0);
  ...
  const [expandedPrompt, setExpandedPrompt] = useState4("");
  const [previewFrames, setPreviewFrames] = useState4([]);
  const [videoUrl, setVideoUrl] = useState4(null);
  const [result, setResult] = useState4(null);
  const [error, setError] = useState4(null);
  const [currentVersionId, setCurrentVersionId] = useState4(null);
  useEffect3(() => {
        ...
        /* @__PURE__ */ jsxs7(
          "details",
          {
            ...
            children: [
              ...
              imgToImgStrength > 0 && /* @__PURE__ */ jsxs7("div", { className: "bfs-field", style: { marginTop: 12 }, children: [
                /* @__PURE__ */ jsx8("label", { className: "bfs-label", htmlFor: "bfs-anchor-refresh", children: "Anchor refresh (img2img drift bound)" }),
                /* @__PURE__ */ jsx8(
                  "input",
                  {
                ...
                /* @__PURE__ */ jsx8("p", { className: "bfs-hint", children: "Restart from fresh noise every N keyframes so long clips don't progressively blur as img2img recursion accumulates VAE round-trip error. 0 = never refresh (carry content forward indefinitely). Try 8\u201312 for clips past ~30 frames." })
              ] })
            ]
          }
        ),
