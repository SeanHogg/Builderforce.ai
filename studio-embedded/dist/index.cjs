...
function StudioPanel({
  ...
  const [currentVersionId, setCurrentVersionId] = (0, import_react3.useState)(null);
  (0, import_react3.useEffect)(() => {
  ...
  const handleLoadVersion = (0, import_react3.useCallback)(async (entry) => {
  ...
  if (status.state === "probing") {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "bfs-root bfs-state-probing", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "bfs-spinner" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { children: "Probing hardware (WebNN \u2192 WebGPU \u2192 CPU)\u2026" })
    ] });
  }
  if (status.state === "unsupported") {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "bfs-root bfs-state-unsupported", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("h2", { children: "AI Video Studio unavailable" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { children: status.reason }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "bfs-hint", children: "Open this page in Chrome 113+ or Edge 113+ with hardware acceleration enabled." })
    ] });
  }
  const device = status.device;
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "bfs-root", children: [
    !hideHeader && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("header", { className: "bfs-header", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("h1", { className: "bfs-title", children: "AI Video Studio" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("p", { className: "bfs-subtitle", children: [
        "Running on ",
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("strong", { children: device.label }),
        device.approxMemoryMb ? ` \xB7 ~${(device.approxMemoryMb / 1024).toFixed(1)} GB available` : ""
      ] })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "bfs-grid", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("section", { className: "bfs-controls", children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "bfs-field", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("label", { className: "bfs-label", htmlFor: "bfs-prompt", children: "What video do you want to generate?" }),
          ...
          expandedPrompt && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("p", { className: "bfs-hint", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("strong", { children: "Expanded:" }),
            " ",
            expandedPrompt
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ModelPicker, { value: model, onChange: setModel, disabled: isGenerating }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "bfs-field", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("label", { className: "bfs-label", children: "Resolution" }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "bfs-radio-row", children: RESOLUTION_PRESETS.map((px) => {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "bfs-hint", children: "Lower = faster + fits weaker GPUs (4\xD7 less compute per step at 256). Higher = sharper, more VRAM, may trip Windows GPU timeouts." })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "bfs-row", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "bfs-field bfs-flex", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("label", { className: "bfs-label", children: "Frames" }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              "input",
              {
                type: "number",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "bfs-field bfs-flex", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("label", { className: "bfs-label", children: "FPS" }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              "input",
              {
                type: "number",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "bfs-field bfs-flex", children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("label", { className: "bfs-label", children: "Duration" }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "bfs-readout", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "bfs-actions", children: [
          isGenerating ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", className: "bfs-btn bfs-btn-danger", onClick: handleCancel, children: "Cancel" }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
            "button",
            {
              type: "button",
          ...
          result && !isGenerating && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { type: "button", className: "bfs-btn bfs-btn-secondary", onClick: handleDownload, children: "Download MP4" })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("section", { className: "bfs-preview-pane", children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          VideoPreview,
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ProgressFeedback, { progressLabel, error }),
        result && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("dl", { className: "bfs-meta", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("dt", { children: "Device" }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("dd", { children: result.activeDevice.toUpperCase() }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("dt", { children: "Frames" }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("dd", { children: result.frames.length }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("dt", { children: "Mamba step" }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("dd", { children: result.mambaState.step }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("dt", { children: "Elapsed" }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("dd", { children: [
            (result.elapsedMs / 1e3).toFixed(2),
            "s"
          ] })
        ] }),
        versions && versions.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "bfs-field", style: { marginTop: 16 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { className: "bfs-label", children: [
            "Versions (",
            versions.length,
            ")"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "bfs-version-list", children: versions.map((v) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
              "button",
              {
                ...
                children: [
                  v.thumbnailUrl ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                    "img",
                    {
                      src: v.thumbnailUrl,
                      alt: "",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: { flex: 1 }, children: v.label }),
                  v.params.parentVersionId ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "bfs-mono", style: { fontSize: "0.7rem", opacity: 0.7 }, children: "\u21AA edit" }) : null
                ]
              },
              v.id
            );
          }) }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "bfs-hint", children: "Click a version to load it as the base. Generating again creates a new version with this one as parent (edit-on-top)." })
        ] }) : null
      ] })
    ] })
  ] });
