/**
 * A model STUCK REPEATING ITSELF, caught while it streams.
 *
 ...
 *
 * ── THE RULE ─────────────────────────────────────────────────────────────────────
 * The TAIL of the stream is the same block, verbatim, {@link LOOP_MIN_COPIES} times in a
