 ...
 */
declare function projectMemoryHooks(projectId: number, request: ProjectMemoryRequest): EvermindRunHooks;
/**
 ...
 */
declare function shippedToBaseBranch(events: BrainTraceEvent[]): boolean;
