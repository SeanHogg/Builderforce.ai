...
interface RepetitionLoop {
    /** The repeated block, as the model wrote it. */
    block: string;
    /** How many whole copies of it sit at the end of the text. */
    copies: number;
    /** The text up to and including the FIRST copy — everything the model said before looping. */
    kept: string;
}
/**
 ...
 */
declare function detectRepetitionLoop(text: string): RepetitionLoop | null;
