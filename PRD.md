...
> **PRD** — drafted by Kevin BA/PM/PO · task #275
...
_Implemented by Developer — task #275, PR #166_

Implemented Guided & Express Input Modes:
- `frontend/src/lib/inputMode.ts` — shared validation schema (FR-4.1), paste-to-fill (FR-3.2),
  ...
  saved templates, coercePayload/parseQueryPrefill, shared submission payload (FR-4.2),
  analytics with <5s flush guarantee (FR-6, AC-12).
