...
```
- Feature/fix short description. (#PR_NUMBER) Thanks @yourhandle. https://docs.builderforce.ai/...
```
...
- [Vision](https://docs.builderforce.ai/vision) — understand the project direction before proposing major changes
