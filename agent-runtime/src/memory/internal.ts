...
/**
 * Canonical memory directory under `.builderforce` (`workspace/.builderforce/memory`).
 */
...
export function isMemoryPath(relPath: string): boolean {
  ...
  // Daily logs are in .builderforce/memory/*.md
  return (
    normalized === "memory" ||
    normalized.startsWith("memory/") ||
    normalized.startsWith(".builderforce/memory/")
  );
}
