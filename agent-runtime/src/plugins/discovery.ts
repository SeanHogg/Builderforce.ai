...
import {
  ...
  type BuilderForceAgentsPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @builderforce/voice-call -> voice-call).
...
export function discoverBuilderForceAgentsPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".builderforce", "extensions")];
