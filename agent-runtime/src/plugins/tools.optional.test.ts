...
const loadBuilderForceAgentsPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadBuilderForceAgentsPlugins: (params: unknown) => loadBuilderForceAgentsPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadBuilderForceAgentsPluginsMock.mockReturnValue(registry);
  return registry;
}

describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadBuilderForceAgentsPluginsMock.mockReset();
  });
