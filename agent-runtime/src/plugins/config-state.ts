...
export const normalizePluginsConfig = (
  config?: BuilderForceAgentsConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: BuilderForceAgentsConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: BuilderForceAgentsConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: BuilderForceAgentsConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
