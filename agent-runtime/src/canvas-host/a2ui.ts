...
export const A2UI_PATH = "/__builderforce__/a2ui";

export const CANVAS_HOST_PATH = "/__builderforce__/canvas";

export const CANVAS_WS_PATH = "/__builderforce__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.builderforceCanvasA2UIAction.postMessage(...)
  // - Android: window.builderforceCanvasA2UIAction.postMessage(...)
  const handlerNames = ["builderforceCanvasA2UIAction"];
  ...
  globalThis.BuilderForceAgents = globalThis.BuilderForceAgents ?? {};
  globalThis.BuilderForceAgents.postMessage = postToNode;
  globalThis.BuilderForceAgents.sendUserAction = sendUserAction;
  globalThis.builderforcePostMessage = postToNode;
  globalThis.builderforceSendUserAction = sendUserAction;
