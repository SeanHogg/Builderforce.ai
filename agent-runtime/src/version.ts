...
const CORE_PACKAGE_NAME = "builderforce";
...
export function resolveRuntimeServiceVersion(
  ...
  return (
    firstNonEmpty(
      env["BUILDERFORCE_AGENTS_VERSION"],
      env["BUILDERFORCE_AGENTS_SERVICE_VERSION"],
      env["npm_package_version"],
    ) ?? fallback
  );
}

// Single source of truth for the current BuilderForceAgents version.
