...
function baseCfg(): BuilderForceAgentsConfig {
  return {
    channels: {
      imessage: {
        dmPolicy: "open",
...
function buildDispatchContextPayload(params: { cfg: BuilderForceAgentsConfig; message: IMessagePayload }) {
...
describe("imessage monitor gating + envelope builders", () => {
  ...
  it("dispatches group messages with mention and builds a group envelope", () => {
    ...
    const message: IMessagePayload = {
      ...
      sender: "+15550002222",
      is_from_me: false,
      text: "@builderforce ping",
      is_group: true,
      chat_name: "Test Squad",
  ...
  it("blocks group messages when imessage.groups is set without a wildcard", () => {
    ...
    const decision = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550001111",
        is_from_me: false,
        text: "@builderforce hello",
        is_group: true,
      },
      opts: {},
      messageText: "@builderforce hello",
      bodyText: "@builderforce hello",
      allowFrom: ["*"],
      groupAllowFrom: [],
      groupPolicy: "open",
      dmPolicy: "open",
  ...
  it("honors group allowlist and ignores pairing-store senders in groups", () => {
    ...
    const denied = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550003333",
        is_from_me: false,
        text: "@builderforce hi",
        is_group: true,
      },
      opts: {},
      messageText: "@builderforce hi",
      bodyText: "@builderforce hi",
      allowFrom: ["*"],
    ...
    const allowed = resolveIMessageInboundDecision({
      ...
      message: {
        ...
        sender: "+15550003333",
        is_from_me: false,
        text: "@builderforce ok",
        is_group: true,
      },
      opts: {},
      messageText: "@builderforce ok",
      bodyText: "@builderforce ok",
      allowFrom: ["*"],
      groupAllowFrom: ["chat_id:101"],
      groupPolicy: "allowlist",
      dmPolicy: "pairing",
