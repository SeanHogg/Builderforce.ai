...
const SANDBOX_EXAMPLES = {
  main: [
    ["builderforce sandbox list", "List all sandbox containers."],
    ["builderforce sandbox list --browser", "List only browser containers."],
    ["builderforce sandbox recreate --all", "Recreate all containers."],
    ["builderforce sandbox recreate --session main", "Recreate a specific session."],
    ["builderforce sandbox recreate --agent mybot", "Recreate agent containers."],
    ["builderforce sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["builderforce sandbox list", "List all sandbox containers."],
    ["builderforce sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ...
    ["builderforce sandbox recreate --session main", "Recreate a specific session."],
    [
      "builderforce sandbox recreate --agent mybot",
      "Recreate a specific agent (includes sub-agents).",
    ],
    ["builderforce sandbox recreate --browser --all", "Recreate only browser containers."],
    ["builderforce sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["builderforce sandbox explain", "Show effective sandbox config."],
    ["builderforce sandbox explain --session agent:main:main", "Explain a specific session."],
    ["builderforce sandbox explain --agent work", "Explain an agent sandbox."],
    ["builderforce sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.builderforce.ai/cli/sandbox")}\n`,
    )
    .action(() => {
