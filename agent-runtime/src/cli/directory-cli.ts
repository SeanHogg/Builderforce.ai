    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["builderforce directory self --channel slack", "Show the connected account identity."],
          [
            'builderforce directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["builderforce directory groups list --channel discord", "List available groups/channels."],
          [
            "builderforce directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.builderforce.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
