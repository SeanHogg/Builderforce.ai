      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["builderforce gateway run", "Run the gateway in the foreground."],
            ["builderforce gateway status", "Show service status and probe reachability."],
            ["builderforce gateway discover", "Find local and wide-area gateway beacons."],
            ["builderforce gateway call health", "Call a gateway RPC method directly."],
