...
const coreEntries: CoreCliEntry[] = [
  ...
  },
  {
    commands: [
      {
        name: "browser",
        description: "Manage BuilderForceAgents's dedicated browser (Chrome/Chromium)",
        hasSubcommands: true,
      },
    ],
    register: async ({ program }) => {
  ...
  },
  {
    commands: [
      ...
      {
        name: "project",
        description: "Manage builderForceAgents project context",
        hasSubcommands: true,
      },
      {
        name: "workforce",
    ...
    register: async ({ program }) => {
      const mod = await import("../../commands/builderforce.js");
      program.addCommand(mod.createInitCommand());
      program.addCommand(mod.createBuilderForceAgentsCommand());
