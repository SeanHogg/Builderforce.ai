...
export function registerOnboardCommand(program: Command) {
  const command = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/onboard", "docs.builderforce.ai/cli/onboard")}\n`,
    )
    .option("--workspace <dir>", "Agent workspace directory (default: ~/.builderforce/workspace)")
    ...
    .option("--auth-choice <choice>", `Auth (default: builderforcellm): ${AUTH_CHOICE_HELP}`)
    .option(
      "--token-provider <id>",
