...
async function runBrowserToggle(
  ...
  const name = status.profile ?? "builderforce";
...
export function registerBrowserManageCommands(
  ...
  browser
    ...
    .action(async (_opts, cmd) => {
      ...
      await runBrowserCommand(async () => {
        ...
        defaultRuntime.log(
          [
            `profile: ${status.profile ?? "builderforce"}`,
  ...
  browser
    ...
    .option("--driver <driver>", "Profile driver (builderforce|extension). Default: builderforce")
    .action(
