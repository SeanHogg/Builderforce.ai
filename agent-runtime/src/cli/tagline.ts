const DEFAULT_TAGLINE = "All your chats, one BuilderForceAgents.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little agentNode-sistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just grew agentNodes—type something and let the bot pinch the busywork.",
  ...
  "Automation with agentNodes: minimal fuss, maximal pinch.",
  ...
  "AgentNodes out, commit in—let's ship something mildly responsible.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.BUILDERFORCE_AGENTS_TAGLINE_INDEX;
