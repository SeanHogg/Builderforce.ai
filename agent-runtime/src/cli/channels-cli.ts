    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["builderforce channels list", "List configured channels and auth profiles."],
          ["builderforce channels status --probe", "Run channel status checks and probes."],
          [
            "builderforce channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["builderforce channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.builderforce.ai/cli/channels",
        )}\n`,
    );
