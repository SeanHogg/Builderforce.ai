...
export const DEFAULT_CLI_NAME = "builderforce";

const KNOWN_CLI_NAMES = new Set([DEFAULT_CLI_NAME, "builderforce"]);
const CLI_PREFIX_RE = /^(?:((?:pnpm|npm|bunx|npx)\s+))?(builderforce|builderforce)\b/;
