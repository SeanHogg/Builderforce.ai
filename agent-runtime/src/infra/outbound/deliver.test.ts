...
const telegramChunkConfig: BuilderForceAgentsConfig = {
  channels: { telegram: { botToken: "tok-1", textChunkLimit: 2 } },
};

const whatsappChunkConfig: BuilderForceAgentsConfig = {
...
describe("deliverOutboundPayloads", () => {
  ...
  it("uses signal media maxBytes from config", async () => {
    ...
    const cfg: BuilderForceAgentsConfig = { channels: { signal: { mediaMaxMb: 2 } } };
