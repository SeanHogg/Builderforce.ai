...
export function listWhatsAppAuthDirs(cfg: BuilderForceAgentsConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: BuilderForceAgentsConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: BuilderForceAgentsConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: BuilderForceAgentsConfig): ResolvedWhatsAppAccount[] {
