...
function mockCredsJsonSpies(readContents: string) {
  const credsSuffix = path.join(".builderforce", "credentials", "whatsapp", "default", "creds.json");
...
describe("web session", () => {
  beforeEach(() => {
    ...
    resetBaileysMocks();
    resetLoadConfigMock();
    // Ensure resolveDefaultWebAuthDir() uses ~/.builderforce (no install-id subdir)
