...
const resolveStorePath = vi.fn(() => "/tmp/builderforce-discord-process-test-sessions.json");
...
beforeEach(() => {
  ...
  resolveStorePath.mockReturnValue("/tmp/builderforce-discord-process-test-sessions.json");
});
