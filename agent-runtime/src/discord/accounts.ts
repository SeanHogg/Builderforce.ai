...
function mergeDiscordAccountConfig(cfg: BuilderForceAgentsConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: BuilderForceAgentsConfig): ResolvedDiscordAccount[] {
