...
// Prefix for BuilderForceAgents-generated action IDs to scope our handler
const BUILDERFORCE_AGENTS_ACTION_PREFIX = "builderforce:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  // Handle BuilderForceAgents modal submissions with callback_ids scoped by our prefix.
  ctx.app.view(
    new RegExp(`^${BUILDERFORCE_AGENTS_ACTION_PREFIX}`),
