...
function mergeSlackAccountConfig(cfg: BuilderForceAgentsConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: BuilderForceAgentsConfig): ResolvedSlackAccount[] {
