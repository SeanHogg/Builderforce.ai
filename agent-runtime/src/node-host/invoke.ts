...
const execHostEnforced = process.env.BUILDERFORCE_AGENTS_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed =
  process.env.BUILDERFORCE_AGENTS_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
