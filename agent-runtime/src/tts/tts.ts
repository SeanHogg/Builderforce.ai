...
export function resolveTtsConfig(cfg: BuilderForceAgentsConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.BUILDERFORCE_AGENTS_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: BuilderForceAgentsConfig): string | undefined {
