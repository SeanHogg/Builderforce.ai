...
describe("loader", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "builderforce-hooks-loader-"));
  });
  ...
  beforeEach(async () => {
    ...
    originalBundledDir = process.env.BUILDERFORCE_AGENTS_BUNDLED_HOOKS_DIR;
    process.env.BUILDERFORCE_AGENTS_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
  ...
  afterEach(async () => {
    ...
    if (originalBundledDir === undefined) {
      delete process.env.BUILDERFORCE_AGENTS_BUNDLED_HOOKS_DIR;
    } else {
      process.env.BUILDERFORCE_AGENTS_BUNDLED_HOOKS_DIR = originalBundledDir;
    }
  });
