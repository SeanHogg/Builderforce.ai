...
type PromptDefaultModelResult = { model?: string; config?: BuilderForceAgentsConfig };
...
function resolveConfiguredModelRaw(cfg: BuilderForceAgentsConfig): string {
...
function resolveConfiguredModelKeys(cfg: BuilderForceAgentsConfig): string[] {
...
export function applyPrimaryModel(cfg: BuilderForceAgentsConfig, model: string): BuilderForceAgentsConfig {
...
export function applyModelAllowlist(cfg: BuilderForceAgentsConfig, models: string[]): BuilderForceAgentsConfig {
  const defaults = cfg.agents?.defaults;
