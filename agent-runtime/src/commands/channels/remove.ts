...
import { type BuilderForceAgentsConfig, writeConfigFile } from "../../config/config.js";
...
function listAccountIds(cfg: BuilderForceAgentsConfig, channel: ChatChannel): string[] {
