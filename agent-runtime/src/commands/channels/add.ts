...
import { writeConfigFile, type BuilderForceAgentsConfig } from "../../config/config.js";
...
function resolveCatalogChannelEntry(raw: string, cfg: BuilderForceAgentsConfig | null) {
