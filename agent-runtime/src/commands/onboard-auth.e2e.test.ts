...
describe("writeOAuthCredentials", () => {
  ...
  it("writes auth-profiles.json under BUILDERFORCE_AGENTS_AGENT_DIR when set", async () => {
    const env = await setupAuthTestEnv("builderforce-oauth-");
...
describe("setMinimaxApiKey", () => {
  ...
  it("writes to BUILDERFORCE_AGENTS_AGENT_DIR when set", async () => {
    const env = await setupAuthTestEnv("builderforce-minimax-", { agentSubdir: "custom-agent" });
    lifecycle.setStateDir(env.stateDir);
