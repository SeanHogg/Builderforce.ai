...
export function applyLitellmProviderConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
...
export function applyLitellmConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
