...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.builderforce.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("builderforce hooks list")}`,
      `  ${formatCliCommand("builderforce hooks enable <name>")}`,
      `  ${formatCliCommand("builderforce hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
