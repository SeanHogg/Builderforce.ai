...
export function applyOpenrouterProviderConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
...
export function applyMoonshotConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
...
export function applyQianfanProviderConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
