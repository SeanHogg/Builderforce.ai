...
export function summarizeExistingConfig(config: BuilderForceAgentsConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.builderforce.ai/gateway/remote",
    "https://docs.builderforce.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
