...
export function applyVercelAiGatewayProviderConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
...
export function applyVercelAiGatewayConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
