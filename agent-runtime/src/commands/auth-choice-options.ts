...
const AUTH_CHOICE_GROUP_DEFS: {
  ...
  },
  {
    ...
    choices: ["builderforcellm", "custom-api-key"],
  },
  {
    value: "builderforcellm",
    label: "BuilderForceAgentsLLM",
    hint: "Local brain; no cloud — local LLM",
    choices: ["builderforcellm-local"],
  },
  {
    value: "openai",
    label: "OpenAI",
...
const BASE_AUTH_CHOICE_OPTIONS: ReadonlyArray<AuthChoiceOption> = [
  ...
  {
    value: "builderforcellm-local",
    label: "BuilderForceAgentsLLM (local brain)",
    hint: "Runs locally, no cloud required",
  },
  {
    value: "builderforcellm",
    label: "BuilderForceAgentsLLM (recommended)",
