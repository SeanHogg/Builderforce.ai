...
export function applyOpencodeZenProviderConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
...
export function applyOpencodeZenConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
