...
export function applyMinimaxProviderConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
...
export function applyMinimaxConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
