...
export function applyOpenAIProviderConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
...
export function applyOpenAIConfig(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
