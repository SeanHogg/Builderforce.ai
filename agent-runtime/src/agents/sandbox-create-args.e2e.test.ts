...
describe("buildSandboxCreateArgs", () => {
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        "create",
        "--name",
        "builderforce-sbx-test",
        "--label",
        "builderforce.sandbox=1",
        "--label",
        "builderforce.sessionKey=main",
        "--label",
        "builderforce.createdAtMs=1700000000000",
        "--label",
        "builderforce.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
  ...
  it("throws on dangerous bind mounts (Docker socket)", () => {
    ...
    expect(() =>
      buildSandboxCreateArgs({
        name: "builderforce-sbx-dangerous",
        cfg,
        scopeKey: "main",
        createdAtMs: 1700000000000,
      }),
  ...
  it("throws on dangerous bind mounts (parent path)", () => {
    ...
    expect(() =>
      buildSandboxCreateArgs({
        name: "builderforce-sbx-dangerous-parent",
        cfg,
        scopeKey: "main",
        createdAtMs: 1700000000000,
      }),
  ...
  it("throws on apparmor unconfined", () => {
    ...
    expect(() =>
      buildSandboxCreateArgs({
        name: "builderforce-sbx-apparmor",
        cfg,
        scopeKey: "main",
        createdAtMs: 1700000000000,
      }),
  ...
  it("omits -v flags when binds is empty or undefined", () => {
    ...
    const args = buildSandboxCreateArgs({
      name: "builderforce-sbx-no-binds",
      cfg,
      scopeKey: "main",
      createdAtMs: 1700000000000,
    });
