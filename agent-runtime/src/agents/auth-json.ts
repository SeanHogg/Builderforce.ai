...
/**
 * Convert an BuilderForceAgents auth-profiles credential to pi-coding-agent auth.json format.
 ...
 *
 * BuilderForceAgents stores credentials in auth-profiles.json instead. This helper
