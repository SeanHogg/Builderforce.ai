...
export type CreateBuilderForceAgentsToolsOpts = Parameters<CreateBuilderForceAgentsTools>[0];
...
export async function getSessionsSpawnTool(opts: CreateBuilderForceAgentsToolsOpts) {
