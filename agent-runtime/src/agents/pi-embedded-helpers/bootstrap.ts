...
export function resolveBootstrapMaxChars(cfg?: BuilderForceAgentsConfig): number {
...
export function resolveBootstrapTotalMaxChars(cfg?: BuilderForceAgentsConfig): number {
