...
function resolveWatchPaths(workspaceDir: string, config?: BuilderForceAgentsConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: BuilderForceAgentsConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: BuilderForceAgentsConfig }) {
