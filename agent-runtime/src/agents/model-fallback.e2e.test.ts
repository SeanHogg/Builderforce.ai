...
function makeCfg(overrides: Partial<BuilderForceAgentsConfig> = {}): BuilderForceAgentsConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeFallbacksOnlyCfg(): BuilderForceAgentsConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeProviderFallbackCfg(provider: string): BuilderForceAgentsConfig {
  return makeCfg({
    agents: {
      defaults: {
        model: {
