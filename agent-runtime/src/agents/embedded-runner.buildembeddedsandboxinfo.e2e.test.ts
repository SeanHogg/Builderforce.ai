...
import { buildEmbeddedSandboxInfo } from "./embedded-runner.js";
...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/builderforce-sandbox",
    agentWorkspaceDir: "/tmp/builderforce-workspace",
    ...
    browser: {
      ...
      containerName: "builderforce-sbx-browser-test",
    },
