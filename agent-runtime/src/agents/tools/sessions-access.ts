...
export function resolveSessionToolsVisibility(cfg: BuilderForceAgentsConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: BuilderForceAgentsConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: BuilderForceAgentsConfig): AgentToAgentPolicy {
