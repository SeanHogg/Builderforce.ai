...
type WebFetchConfig = NonNullable<BuilderForceAgentsConfig["tools"]>["web"] extends infer Web
...
function resolveFetchConfig(cfg?: BuilderForceAgentsConfig): WebFetchConfig {
