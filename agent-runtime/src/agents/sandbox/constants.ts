...
export const DEFAULT_SANDBOX_IMAGE = "builderforce-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "builderforce-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "builderforce-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "builderforce-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "builderforce-sbx-browser-";
