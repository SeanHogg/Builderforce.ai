...
export function resolveDefaultAgentWorkspaceDir(
  ...
  const profile = env.BUILDERFORCE_AGENTS_PROFILE?.trim();
  if (profile && profile.toLowerCase() !== "default") {
    return path.join(home, ".builderforce", `workspace-${profile}`);
  }
  return path.join(home, ".builderforce", "workspace");
}
...
export const WORKSPACE_RUNTIME_DIRNAME = ".builderforce";
