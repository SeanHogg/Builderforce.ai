...
type BuilderForceAgentsReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: BuilderForceAgentsReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createBuilderForceAgentsReadTool(base, {
...
export function createBuilderForceAgentsReadTool(
  base: AnyAgentTool,
  options?: BuilderForceAgentsReadToolOptions,
): AnyAgentTool {
