 ...
 * 1. Parse `MEDIA:` tokens from text content blocks (all BuilderForceAgents tools).
 * 2. Fall back to `details.path` when image content exists (BuilderForceAgents imageResult).
 *
