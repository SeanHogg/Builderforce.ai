...
describe("createBuilderForceAgentsCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createBuilderForceAgentsCodingTools({
      config,
    ...
    const anthropicTools = createBuilderForceAgentsCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createBuilderForceAgentsCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createBuilderForceAgentsCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
