...
const CLEANUP_STATE_KEY = Symbol.for("builderforce.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("builderforce.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("builderforce.sessionWriteLockWatchdogState");
