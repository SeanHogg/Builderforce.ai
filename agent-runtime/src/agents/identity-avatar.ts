...
function resolveAvatarSource(cfg: BuilderForceAgentsConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: BuilderForceAgentsConfig, agentId: string): AgentAvatarResolution {
