...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof BuilderForceAgentsConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: BuilderForceAgentsConfig; env: NodeJS.ProcessEnv }): {
  cfg: BuilderForceAgentsConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
