...
export const getHandshakeTimeoutMs = () => {
  if (process.env.VITEST && process.env.BUILDERFORCE_AGENTS_TEST_HANDSHAKE_TIMEOUT_MS) {
    const parsed = Number(process.env.BUILDERFORCE_AGENTS_TEST_HANDSHAKE_TIMEOUT_MS);
