 ...
 *
 * @see https://github.com/seanhogg/builderforce/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an BuilderForceAgentsConfig.
 */
export function timestampOptsFromConfig(cfg: BuilderForceAgentsConfig): TimestampInjectionOptions {
  return {
