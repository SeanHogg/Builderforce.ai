...
function listConfiguredAgentIds(cfg: BuilderForceAgentsConfig): string[] {
...
export function listAgentsForGateway(cfg: BuilderForceAgentsConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: BuilderForceAgentsConfig): string {
...
function resolveSessionStoreAgentId(cfg: BuilderForceAgentsConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: BuilderForceAgentsConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: BuilderForceAgentsConfig): GatewaySessionsDefaults {
