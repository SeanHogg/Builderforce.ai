...
import type { BuilderForceAgentsConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: BuilderForceAgentsConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: BuilderForceAgentsConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: BuilderForceAgentsConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: BuilderForceAgentsConfig) => void;
  log: {
