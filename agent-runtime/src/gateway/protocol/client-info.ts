export const GATEWAY_CLIENT_IDS = {
  ...
  CONTROL_UI: "builderforce-control-ui",
  BUILDERFORCE_AGENTS_CONTROL_UI: "builderforce-control-ui",
  WEBCHAT: "webchat",
  CLI: "cli",
  GATEWAY_CLIENT: "gateway-client",
  MACOS_APP: "builderforce-macos",
  IOS_APP: "builderforce-ios",
  ANDROID_APP: "builderforce-android",
  NODE_HOST: "node-host",
  TEST: "test",
  FINGERPRINT: "fingerprint",
  PROBE: "builderforce-probe",
} as const;
