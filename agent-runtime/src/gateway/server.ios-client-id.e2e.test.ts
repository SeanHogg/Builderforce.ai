...
beforeAll(async () => {
  previousToken = process.env.BUILDERFORCE_AGENTS_GATEWAY_TOKEN;
  process.env.BUILDERFORCE_AGENTS_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
test.each([
  { clientId: "builderforce-ios", platform: "ios" },
  { clientId: "builderforce-android", platform: "android" },
