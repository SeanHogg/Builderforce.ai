...
export const FIELD_HELP: Record<string, string> = {
  "meta.lastTouchedVersion": "Auto-set when BuilderForceAgents writes the config.",
  ...
  "gateway.controlUi.basePath":
    "Optional URL prefix where the Control UI is served (e.g. /builderforce).",
  ...
  "diagnostics.cacheTrace.filePath":
    "JSONL output path for cache trace logs (default: $BUILDERFORCE_AGENTS_STATE_DIR/logs/cache-trace.jsonl).",
  ...
  "agents.defaults.memorySearch":
    "Vector search over .builderforce/MEMORY.md and .builderforce/memory/*.md (per-agent overrides supported).",
  ...
  "agents.defaults.memorySearch.store.path":
    "SQLite index path (default: ~/.builderforce/memory/{agentId}.sqlite).",
  ...
  "memory.backend": 'Memory backend ("builtin" for BuilderForceAgents embeddings, "qmd" for QMD sidecar).',
  "memory.citations": 'Default citation behavior ("auto", "on", or "off").',
  "memory.qmd.command": "Path to the qmd binary (default: resolves from PATH).",
  "memory.qmd.includeDefaultMemory":
    "Whether to automatically index .builderforce/MEMORY.md + .builderforce/memory/**/*.md (default: true).",
  "memory.qmd.paths":
  ...
  "plugins.installs":
    "CLI-managed install metadata (used by `builderforce plugins update` to locate install sources).",
  "plugins.installs.*.source": 'Install source ("npm", "archive", or "path").',
  "plugins.installs.*.spec": "Original npm spec used for install (if source is npm).",
  "plugins.installs.*.sourcePath": "Original archive/path used for install (if any).",
  "plugins.installs.*.installPath":
    "Resolved install directory (usually ~/.builderforce/extensions/<id>).",
