...
export type BuilderForceAgentsConfig = {
  meta?: {
    /** Last BuilderForceAgents version that wrote this config. */
  ...
  ui?: {
    /** Accent color for BuilderForceAgents UI chrome (hex). */
    seamColor?: string;
    assistant?: {
   ...
   *
   * Env override: BUILDERFORCE_AGENTS_LOCAL_BRAIN=0 disables both preprocessors.
   */
  localBrain?: {
