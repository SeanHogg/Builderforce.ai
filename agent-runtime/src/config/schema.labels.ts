...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.fs.convergedFileTools": "Converged (shared) file tools",
  ...
  "tools.web.search.keylessFallback": "Web Search Keyless Fallback",
  "tools.web.search.keyless.searxngUrl": "Web Search SearXNG URL",
