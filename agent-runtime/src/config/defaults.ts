...
function resolveAnthropicDefaultAuthMode(cfg: BuilderForceAgentsConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
...
export function applySessionDefaults(
  ...
  const next: BuilderForceAgentsConfig = {
    ...cfg,
...
export function applyTalkApiKey(config: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
...
export function applyModelDefaults(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
...
export function applyLoggingDefaults(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
...
export function applyContextPruningDefaults(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
...
export function applyCompactionDefaults(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
