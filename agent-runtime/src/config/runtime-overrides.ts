...
export function applyConfigOverrides(cfg: BuilderForceAgentsConfig): BuilderForceAgentsConfig {
  if (!overrides || Object.keys(overrides).length === 0) {
    return cfg;
  }
  return mergeOverrides(cfg, overrides) as BuilderForceAgentsConfig;
}
