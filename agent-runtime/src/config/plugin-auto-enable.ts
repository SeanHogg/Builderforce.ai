...
import type { BuilderForceAgentsConfig } from "./config.js";
...
function isTelegramConfigured(cfg: BuilderForceAgentsConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: BuilderForceAgentsConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: BuilderForceAgentsConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: BuilderForceAgentsConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: BuilderForceAgentsConfig): boolean {
...
function isIMessageConfigured(cfg: BuilderForceAgentsConfig): boolean {
...
function isWhatsAppConfigured(cfg: BuilderForceAgentsConfig): boolean {
...
function isGenericChannelConfigured(cfg: BuilderForceAgentsConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: BuilderForceAgentsConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: BuilderForceAgentsConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: BuilderForceAgentsConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: BuilderForceAgentsConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: BuilderForceAgentsConfig, pluginId: string): BuilderForceAgentsConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
