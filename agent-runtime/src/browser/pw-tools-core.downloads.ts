...
import { resolvePreferredBuilderForceAgentsTmpDir } from "../infra/tmp-builderforce-dir.js";
import {
  ensurePageState,
  getPageForTargetId,
  refLocator,
...
function buildTempDownloadPath(fileName: string): string {
  ...
  return path.join(resolvePreferredBuilderForceAgentsTmpDir(), "downloads", `${id}-${safeName}`);
}
