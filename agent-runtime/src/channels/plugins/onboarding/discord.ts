...
function setDiscordDmPolicy(cfg: BuilderForceAgentsConfig, dmPolicy: DmPolicy) {
...
function setDiscordAllowFrom(cfg: BuilderForceAgentsConfig, allowFrom: string[]): BuilderForceAgentsConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
