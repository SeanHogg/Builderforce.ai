...
export type ChannelAgentToolFactory = (params: { cfg?: BuilderForceAgentsConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: BuilderForceAgentsConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: BuilderForceAgentsConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: BuilderForceAgentsConfig }) => boolean;
  supportsCards?: (params: { cfg: BuilderForceAgentsConfig }) => boolean;
