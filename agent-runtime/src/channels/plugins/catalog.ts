...
import { discoverBuilderForceAgentsPlugins } from "../../plugins/discovery.js";
import type { BuilderForceAgentsPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, BuilderForceAgentsPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["BUILDERFORCE_AGENTS_PLUGIN_CATALOG_PATHS", "BUILDERFORCE_AGENTS_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<BuilderForceAgentsPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: BuilderForceAgentsPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: BuilderForceAgentsPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverBuilderForceAgentsPlugins({ workspaceDir: options.workspaceDir });
