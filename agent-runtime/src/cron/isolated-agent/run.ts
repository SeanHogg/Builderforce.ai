...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/SeanHogg/Builderforce.ai/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.BUILDERFORCE_AGENTS_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.builderforce/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: BuilderForceAgentsConfig = {
    ...params.cfg,
