...
describe("runCronIsolatedAgentTurn — skill filter", () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    previousFastTestEnv = process.env.BUILDERFORCE_AGENTS_TEST_FAST;
    delete process.env.BUILDERFORCE_AGENTS_TEST_FAST;
  ...
  afterEach(() => {
    ...
    process.env.BUILDERFORCE_AGENTS_TEST_FAST = previousFastTestEnv;
  });
