...
function resolveSystemdServiceName(env: Record<string, string | undefined>): string {
  ...
  return resolveGatewaySystemdServiceName(env.BUILDERFORCE_AGENTS_PROFILE);
}
...
export async function installSystemdService({
  ...
  const serviceName = resolveGatewaySystemdServiceName(env.BUILDERFORCE_AGENTS_PROFILE);
