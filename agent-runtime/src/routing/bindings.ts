...
export function listBindings(cfg: BuilderForceAgentsConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: BuilderForceAgentsConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: BuilderForceAgentsConfig) {
