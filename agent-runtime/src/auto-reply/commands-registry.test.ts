...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@builderforce", { botUsername: "builderforce" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@builderforce args", {
        botUsername: "builderforce",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@builderforce: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "builderforce" })).toBe(
      "/help@otherbot",
    );
  });
