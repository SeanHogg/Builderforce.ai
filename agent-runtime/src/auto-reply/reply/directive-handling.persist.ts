...
export async function persistInlineDirectives(params: {
  ...
  agentCfg: NonNullable<BuilderForceAgentsConfig["agents"]>["defaults"] | undefined;
...
export function resolveDefaultModel(params: { cfg: BuilderForceAgentsConfig; agentId?: string }): {
  defaultProvider: string;
  defaultModel: string;
  aliasIndex: ModelAliasIndex;
} {
