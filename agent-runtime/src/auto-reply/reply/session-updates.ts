...
export async function prependSystemEvents(params: {
  ...
  const resolveSystemEventTimezone = (cfg: BuilderForceAgentsConfig) => {
  ...
  const formatSystemEventTimestamp = (ts: number, cfg: BuilderForceAgentsConfig) => {
...
export async function ensureSkillSnapshot(params: {
  ...
  if (process.env.BUILDERFORCE_AGENTS_TEST_FAST === "1") {
