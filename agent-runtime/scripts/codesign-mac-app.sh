...
ENT_TMP_BASE=$(mktemp -t builderforce-entitlements-base.XXXXXX)
ENT_TMP_APP_BASE=$(mktemp -t builderforce-entitlements-app-base.XXXXXX)
ENT_TMP_RUNTIME=$(mktemp -t builderforce-entitlements-runtime.XXXXXX)
