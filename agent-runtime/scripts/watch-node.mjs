...
export async function runWatchMain(params = {}) {
  ...
  childEnv.BUILDERFORCE_AGENTS_WATCH_MODE = "1";
  childEnv.BUILDERFORCE_AGENTS_WATCH_SESSION = watchSession;
  if (deps.args.length > 0) {
    childEnv.BUILDERFORCE_AGENTS_WATCH_COMMAND = deps.args.join(" ");
  }
