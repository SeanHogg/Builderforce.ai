...
docker run --rm -t \
  ...
  -e BUILDERFORCE_AGENTS_LIVE_GATEWAY_MODELS="${BUILDERFORCE_AGENTS_LIVE_GATEWAY_MODELS:-${BUILDERFORCE_AGENTS_LIVE_GATEWAY_MODELS:-all}}" \
  -e BUILDERFORCE_AGENTS_LIVE_GATEWAY_PROVIDERS="${BUILDERFORCE_AGENTS_LIVE_GATEWAY_PROVIDERS:-${BUILDERFORCE_AGENTS_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e BUILDERFORCE_AGENTS_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${BUILDERFORCE_AGENTS_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${BUILDERFORCE_AGENTS_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
