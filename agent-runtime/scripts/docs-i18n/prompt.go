...
- Keep product names in English: OpenAgentNode, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the OpenAgentNode Gateway, use “Gateway 网关”.
