...
if [[ -z "$version_content" ]]; then
  echo "<h2>BuilderForceAgents $VERSION</h2>"
  echo "<p>Latest BuilderForceAgents update.</p>"
  echo "<p><a href=\"https://github.com/seanhogg/builderforce/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
