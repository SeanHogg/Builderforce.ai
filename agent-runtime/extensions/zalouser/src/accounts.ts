...
export function listZalouserAccountIds(cfg: BuilderForceAgentsConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: BuilderForceAgentsConfig): string {
