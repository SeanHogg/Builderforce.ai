import type { BuilderForceAgentsConfig, DmPolicy } from "@seanhogg/builderforce-agents/plugin-sdk";
import {
...
function setGoogleChatDmPolicy(cfg: BuilderForceAgentsConfig, policy: DmPolicy) {
  const allowFrom =
    policy === "open"
