...
export function listGoogleChatAccountIds(cfg: BuilderForceAgentsConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: BuilderForceAgentsConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: BuilderForceAgentsConfig): ResolvedGoogleChatAccount[] {
