 ...
 */
export function listNostrAccountIds(cfg: BuilderForceAgentsConfig): string[] {
 ...
 */
export function resolveDefaultNostrAccountId(cfg: BuilderForceAgentsConfig): string {
