...
Nostr DM channel plugin for BuilderForceAgents using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to BuilderForceAgents. It enables your bot to:
...
# Configure builderforce to use local relay
