import type { BaseProbeResult } from "@seanhogg/builderforce-agents/plugin-sdk";
import type {
...
export type CoreConfig = BuilderForceAgentsConfig & {
  channels?: BuilderForceAgentsConfig["channels"] & {
    irc?: IrcConfig;
  };
};
