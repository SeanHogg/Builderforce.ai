...
export function listMattermostAccountIds(cfg: BuilderForceAgentsConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: BuilderForceAgentsConfig): string {
...
export function listEnabledMattermostAccounts(cfg: BuilderForceAgentsConfig): ResolvedMattermostAccount[] {
