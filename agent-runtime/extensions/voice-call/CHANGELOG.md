...
- Version alignment with core BuilderForceAgents release numbers.
...
- First public release of the @builderforce/voice-call plugin.
...
- CLI: `builderforce voicecall` commands (call/start/continue/speak/end/status/tail/expose).
