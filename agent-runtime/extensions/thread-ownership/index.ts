import type { BuilderForceAgentsConfig, BuilderForceAgentsPluginApi } from "@seanhogg/builderforce-agents/plugin-sdk";
...
function resolveOwnershipAgent(config: BuilderForceAgentsConfig): { id: string; name: string } {
