...
function setFeishuDmPolicy(cfg: BuilderForceAgentsConfig, dmPolicy: DmPolicy): BuilderForceAgentsConfig {
  const allowFrom =
    dmPolicy === "open"
...
function setFeishuAllowFrom(cfg: BuilderForceAgentsConfig, allowFrom: string[]): BuilderForceAgentsConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
...
function setFeishuGroupAllowFrom(cfg: BuilderForceAgentsConfig, groupAllowFrom: string[]): BuilderForceAgentsConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
