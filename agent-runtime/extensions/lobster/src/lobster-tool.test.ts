...
import type { BuilderForceAgentsPluginApi, BuilderForceAgentsPluginToolContext } from "../../../src/plugins/types.js";
...
function fakeApi(overrides: Partial<BuilderForceAgentsPluginApi> = {}): BuilderForceAgentsPluginApi {
  return {
    id: "lobster",
    name: "lobster",
    source: "test",
...
function fakeCtx(overrides: Partial<BuilderForceAgentsPluginToolContext> = {}): BuilderForceAgentsPluginToolContext {
  return {
    config: {},
    workspaceDir: "/tmp",
    agentDir: "/tmp",
...
describe("lobster plugin tool", () => {
  ...
  beforeAll(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "builderforce-lobster-plugin-"));
  ...
  it("can be gated off in sandboxed contexts", async () => {
    const api = fakeApi();
    const factoryTool = (ctx: BuilderForceAgentsPluginToolContext) => {
      if (ctx.sandboxed) {
        return null;
      }
