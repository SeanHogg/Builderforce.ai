...
function setMSTeamsDmPolicy(cfg: BuilderForceAgentsConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: BuilderForceAgentsConfig, allowFrom: string[]): BuilderForceAgentsConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
