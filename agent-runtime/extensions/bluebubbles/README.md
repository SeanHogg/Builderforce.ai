...
This directory contains the **BlueBubbles external channel plugin** for BuilderForceAgents.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `builderforce/plugin-sdk` helpers.
