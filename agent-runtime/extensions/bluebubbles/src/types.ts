import type { DmPolicy, GroupPolicy } from "@seanhogg/builderforce-agents/plugin-sdk";

export type { DmPolicy, GroupPolicy } from "@seanhogg/builderforce-agents/plugin-sdk";
