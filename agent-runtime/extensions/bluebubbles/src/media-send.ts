...
import { resolveChannelMediaMaxBytes, type BuilderForceAgentsConfig } from "@seanhogg/builderforce-agents/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: BuilderForceAgentsConfig; accountId?: string }): string[] {
