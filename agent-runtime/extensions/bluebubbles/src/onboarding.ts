...
function setBlueBubblesDmPolicy(cfg: BuilderForceAgentsConfig, dmPolicy: DmPolicy): BuilderForceAgentsConfig {
  const allowFrom =
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "2. Add your BuilderForceAgents gateway URL + webhook path",
