...
export const DOMAIN_MANIFEST: Readonly<Record<Domain, DomainManifest>> = {
  ...
  finance:      { domain: 'finance',      seat: 'CFO',        rootKind: 'ledger_entry',     kinds: ['invoice', 'bill', 'expense', 'scenario', 'plan', 'shareClass', 'equityGrant', 'convertible', 'payRun'], metrics: ['finance.mrr', 'finance.burn', 'finance.runway_months'], rung: 2 },
