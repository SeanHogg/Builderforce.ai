  ...
  return (
    <div className="grj-root">
      ...
      <style>{`
        ...
        .grj-emoji { font-size: var(--font-size-page-title); }
        .grj-title { font-size: var(--font-size-card-title); font-weight: 600; color: var(--text-primary); }
        .grj-body { font-size: var(--font-size-small); line-height: 1.5; max-width: 360px; }
        .grj-form { display: flex; flex-direction: column; gap: 8px; width: 100%; max-width: 320px; margin-top: 6px; text-align: left; }
        .grj-label { font-size: var(--font-size-small); font-weight: 600; color: var(--text-primary); }
        .grj-input { width: 100%; box-sizing: border-box; padding: 9px 11px; font-size: var(--font-size-small); font-family: inherit; border: 1px solid var(--border-subtle); border-radius: var(--radius-lg); background: var(--bg-base); color: var(--text-primary); }
        .grj-join { padding: 10px 20px; font-size: var(--font-size-small); font-weight: 600; border: none; border-radius: var(--radius-lg); background: var(--accent); color: var(--text-on-accent); cursor: pointer; min-height: 40px; }
        .grj-join:disabled { opacity: 0.55; cursor: default; }
        .grj-error { margin: 0; font-size: var(--font-size-small); color: var(--danger); }
      `}</style>
    </div>
  );
}
