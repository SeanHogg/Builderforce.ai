  ...
  return (
    <div className="gr-bar">
      ...
      <style>{`
        ...
        .gr-person { display: inline-flex; align-items: center; gap: 5px; padding: 3px 8px 3px 3px; border-radius: 999px; background: var(--bg-base); border: 1px solid var(--border-subtle); font-size: 12px; color: var(--text-primary); max-width: 160px; }
        .gr-avatar { width: 20px; height: 20px; border-radius: 50%; display: grid; place-items: center; background: var(--accent, #3b82f6); color: #fff; font-size: 11px; font-weight: 700; flex-shrink: 0; }
