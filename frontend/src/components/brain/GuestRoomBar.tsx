  ...
  return (
    <div className="gr-bar">
      ...
      <style>{`
        ...
        .gr-bar-title { display: flex; align-items: center; gap: 7px; font-size: var(--font-size-small); font-weight: 600; color: var(--text-primary); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 100%; }
        .gr-dot { width: 8px; height: 8px; border-radius: 50%; background: var(--text-muted); flex-shrink: 0; }
        .gr-dot-live { background: var(--success); }
        .gr-bar-count { font-size: var(--font-size-small); color: var(--text-muted); white-space: nowrap; }
        .gr-people { display: flex; align-items: center; gap: 6px; margin: 0; padding: 0; list-style: none; flex-wrap: wrap; min-width: 0; }
        .gr-person { display: inline-flex; align-items: center; gap: 5px; padding: 3px 8px 3px 3px; border-radius: var(--radius-full); background: var(--bg-base); border: 1px solid var(--border-subtle); font-size: var(--font-size-small); color: var(--text-primary); max-width: 160px; }
        .gr-avatar { width: 20px; height: 20px; border-radius: 50%; display: grid; place-items: center; background: var(--accent); color: var(--text-on-accent); font-size: var(--font-size-eyebrow); font-weight: 700; flex-shrink: 0; }
        ...
        .gr-btn { padding: 6px 11px; font-size: var(--font-size-small); font-weight: 600; border-radius: var(--radius-md); border: 1px solid var(--border-subtle); background: var(--bg-base); color: var(--text-primary); cursor: pointer; min-height: 32px; }
        .gr-btn:disabled { opacity: 0.55; cursor: default; }
        .gr-btn-quiet { background: transparent; color: var(--text-muted); }
        .gr-busy { margin: 0; font-size: var(--font-size-small); color: var(--text-muted); }
