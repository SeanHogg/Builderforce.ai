...
/**
 * Renders a Mermaid diagram from source. THE RENDERER — reached only through
 * `./MermaidDiagram`, which is what keeps it out of the server build; see that file.
 *
 * Mermaid is loaded lazily (client-only) so it never runs during SSR. LLM-authored
 ...
 */
export function MermaidDiagramView({ code }: { code: string }) {
