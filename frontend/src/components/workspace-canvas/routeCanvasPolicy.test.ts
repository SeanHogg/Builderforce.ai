...
describe('route canvas policy', () => {
  it.each(['/create', '/create/local-1', '/dashboard', '/projects', '/insights', '/insights/ai', '/insights/delivery', '/brainstorm', '/workflows/builder'])(
    'does not nest the native canvas route %s',
    (pathname) => expect(isNativeCanvasRoute(pathname)).toBe(true),
  );

  it.each(['/workforce', '/insights/finance', '/knowledge/12', '/settings', '/ide/12', '/projects/12', '/projects/rfp/9'])(
