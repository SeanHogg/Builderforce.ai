...
const styles = `
  ...
  .bdf-label { font-size: var(--font-size-small); font-weight: 600; color: var(--text-primary, var(--text-primary)); }
  .bdf-input {
    width: 100%; box-sizing: border-box; padding: 10px 12px; border-radius: var(--radius-lg);
    border: 1px solid var(--border, rgba(255,255,255,0.14));
    background: var(--surface-2, rgba(255,255,255,0.04));
    color: var(--text-primary, var(--text-primary)); font-size: var(--font-size-small); font-family: inherit;
  }
  ...
  .bdf-error { margin: 0; color: var(--red-bright); font-size: var(--font-size-small); }
  .bdf-submit {
    margin-top: 4px; padding: 12px 18px; border: none; border-radius: var(--radius-lg); cursor: pointer;
  ...
  .bdf-success-icon {
    width: 48px; height: 48px; margin: 0 auto 12px; border-radius: var(--radius-full); display: grid; place-items: center;
    background: var(--surface-cyan-soft, rgba(0,229,204,0.14)); color: var(--cyan-bright, var(--cyan-bright)); font-size: var(--font-size-section); font-weight: 800;
  }
  .bdf-success-title { margin: 0 0 6px; font-size: var(--font-size-card-title); font-weight: 700; color: var(--text-primary, var(--text-primary)); }
  .bdf-success-body { margin: 0; color: var(--text-secondary); font-size: var(--font-size-small); }
`;
