...
export const INTEGRATIONS: Integration[] = [
  ...
  { id: 'xai-grok', label: 'xAI Grok', category: 'llm', kind: 'llm', auth: 'api-key', icon: '✖️', description: 'Grok models for chat, reasoning, and agentic tool calling.', operations: [{ id: 'chat-completion', label: 'Chat completion' }, { id: 'tool-use', label: 'Agentic tool calling' }, { id: 'vision', label: 'Image understanding' }], defaultModel: 'direct/xai/grok-4.6' },
