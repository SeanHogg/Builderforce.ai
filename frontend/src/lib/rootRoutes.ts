...
export const APP_ROUTE_SEGMENTS: readonly string[] = [
  ...
  'cofounder', 'compare', 'compile', 'content-manager', 'contributors', 'create',
  'creation-canvas', 'crm', 'dashboard', 'dashboards', 'data-rooms', 'deal', 'debug',
  'demo', 'developers', 'diagnostics', 'docs', 'embed', 'embedded', 'evermind', 'f',
  'facts', 'features', 'finops', 'freelancer', 'growth', 'hires', 'import', 'inbox',
  ...
  'models', 'monitoring', 'personas', 'pmo', 'pricing', 'product', 'projects', 'prompts',
