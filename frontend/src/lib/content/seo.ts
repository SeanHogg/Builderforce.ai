...
export const RELATED_ARTICLES: Record<string, string[]> = {
  ...
  workforce: ['real-time-collaboration-humans-and-agents', 'multi-party-team-chat-humans-and-agents', 'choose-who-answers-not-just-who-you-ask','fleet-management-and-agent-routing', 'how-to-run-effective-one-on-ones', 'how-to-build-an-org-chart-that-stays-accurate', 'team-health-signals-every-manager-should-watch'],
  ...
  personas: ['choose-who-answers-not-just-who-you-ask', 'ai-agent-personality-psychometric-personas','builderforce-agents-and-agent-integration', 'multi-agent-orchestration'],
