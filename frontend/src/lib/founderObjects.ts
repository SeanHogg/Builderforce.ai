...
export const FOUNDER_OBJECT_SPECS: readonly FounderObjectSpec[] = [
  ...
  },
  {
    ...
    fields: [
      { name: 'watches', render: 'stat', label: 'watches', hint: 'Title of the liveMetric object on this board that this trigger evaluates.' },
      { name: 'comparator', render: 'stat', label: 'comparator', hint: 'below | above | equals | changes-by.' },
      { name: 'threshold', render: 'stat', label: 'threshold', hint: 'The number the comparator tests against.' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'closeTarget', render: 'stat', label: 'closeTarget', hint: 'ISO date you intend to close.' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'dueAt', render: 'stat', label: 'dueAt', hint: 'ISO date payment is due. This is the field that makes an invoice something the board can warn about, so an invoice without it cannot age.' },
  ...
  },
  {
    ...
    fields: [
      ...
      CURRENCY_FIELD,
      { name: 'amount', render: 'stat', label: 'amount', hint: `${EXACT_MONEY_HINT} The total payable including tax.` },
      { name: 'dueAt', render: 'stat', label: 'dueAt', hint: 'ISO date payment is due.' },
