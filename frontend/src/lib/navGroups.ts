...
/**
 * Progressive disclosure (§11.4.4) is still the rule — a row is ALWAYS LISTED
 * and a dim row is an invitation — but the RUNG LADDER that used to express it
 * here is gone, and the row no longer declares one.
 *
 * It was a second, parallel answer to "may this visitor open this?", and guest
 * preview had already given the first one: a signed-out visitor gets the real
 * surface on every app route that is not operator tooling. The two disagreed
 * wherever it was most visible — a guest reading `/incidents` over the sample
 * workspace saw a padlock on the very row they were standing on, and eight more
 * beside it. Reachability is now asked once, of `destinationReachable`, which
 * asks the routing that actually renders the page. See its doc comment.
 */
...
export const NAV_GROUPS: NavGroup[] = [
  ...
  { id: 'create', labelKey: 'group.create', icon: '✦', href: '/create', match: ['/create', '/brainstorm', '/workflows', '/challenges', '/realize'], seat: 'Brain', stage: 'idea' },
  ...
  { id: 'marketplace', labelKey: 'group.marketplace', icon: '🛒', href: '/marketplace', match: ['/marketplace', '/talent', '/templates'], seat: 'platform', stage: 'market' },
  ...
  { id: 'developers', labelKey: 'group.developers', icon: '🧩', href: '/developers', match: ['/developers'], seat: 'platform', stage: 'market' },
  ...
  { id: 'disputes', labelKey: 'group.disputes', icon: '⚖', href: '/disputes', match: ['/disputes'], seat: 'CFO', stage: 'run' },
  // ── ADMIN ────────────────────────────────────────────────────────────────
  {
...
export const FOR_HIRE_NAV_GROUPS: NavGroup[] = [
  ...
  { id: 'freelancer-gigs', labelKey: 'group.findWork', icon: '🔎', href: '/marketplace?family=talent&kind=gig', match: ['/marketplace', '/freelancer/gigs'], seat: 'platform', stage: 'market' },
  ...
  { id: 'freelancer-earnings', labelKey: 'group.earnings', icon: '💰', href: '/freelancer/earnings', match: ['/freelancer/earnings'], seat: 'platform', stage: 'measure' },
  ...
  { id: 'freelancer-disputes', labelKey: 'group.disputes', icon: '⚖', href: '/freelancer/disputes', match: ['/freelancer/disputes'], seat: 'platform', stage: 'run' },
];
