...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: '700', color: 'var(--text-on-accent)' },
  ...
  counter: { fontSize: 48, fontWeight: '700', color: 'var(--text-on-accent)', marginVertical: 8 },
  button: {
  ...
  buttonText: { color: 'var(--text-on-accent)', fontSize: 16, fontWeight: '600' },
});`,
