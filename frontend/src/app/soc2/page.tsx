  ...
  return (
    <>
      ...
      <style>{`
        ...
        .s2-title { font-weight: 800; letter-spacing: -0.03em; line-height: 1.08; font-size: var(--font-size-page-title); margin: 0 auto 16px; max-width: 15ch; }
        ...
        .s2-sub { font-size: var(--font-size-lede); color: var(--text-secondary); line-height: 1.65; margin: 0 auto 28px; max-width: 62ch; }
        .s2-actions { display: flex; gap: 12px; flex-wrap: wrap; justify-content: center; }
        .s2-btn-primary { display: inline-flex; align-items: center; gap: 8px; padding: 13px 26px; border-radius: var(--radius-lg); background: linear-gradient(135deg, var(--coral-bright), var(--coral-dark)); color: var(--text-on-accent); font-weight: 600; font-size: var(--font-size-body); text-decoration: none; box-shadow: 0 6px 20px var(--shadow-coral-mid, rgba(244,114,110,0.28)); transition: transform 0.2s ease; }
        .s2-btn-primary:hover { transform: translateY(-2px); }
        .s2-btn-secondary { display: inline-flex; align-items: center; gap: 8px; padding: 13px 26px; border-radius: var(--radius-lg); border: 1px solid var(--border-subtle); background: var(--surface-card, var(--bg-elevated)); color: var(--text-primary); font-weight: 600; font-size: var(--font-size-body); text-decoration: none; }
        .s2-section { padding: clamp(36px, 6vw, 64px) 0; }
        .s2-section-title { font-weight: 700; font-size: var(--font-size-section); letter-spacing: -0.02em; text-align: center; margin: 0 0 8px; }
        .s2-section-sub { text-align: center; color: var(--text-secondary); font-size: var(--font-size-card-title); max-width: 60ch; margin: 0 auto 32px; line-height: 1.6; }
        ...
        .s2-cc-ref { font-weight: 800; color: var(--coral-bright); font-size: var(--font-size-small); letter-spacing: 0.04em; }
        .s2-cc-label { display: block; margin-top: 4px; color: var(--text-primary); font-size: var(--font-size-body); line-height: 1.4; }
        ...
        .s2-step-t { font-weight: 700; font-size: var(--font-size-card-title); margin: 0 0 4px; }
        .s2-step-d { color: var(--text-secondary); font-size: var(--font-size-body); line-height: 1.5; margin: 0; }
        .s2-audit-icon { font-size: var(--font-size-section); }
        .s2-audit-name { font-weight: 700; font-size: var(--font-size-card-title); margin: 8px 0 4px; }
        .s2-audit-desc { color: var(--text-secondary); font-size: var(--font-size-body); line-height: 1.5; margin: 0; }
        ...
        .s2-faq p { color: var(--text-secondary); font-size: var(--font-size-body); line-height: 1.6; margin: 10px 0 0; }
        ...
        .s2-cta h2 { font-size: var(--font-size-section); font-weight: 700; margin: 0 0 10px; }
