  ...
  return (
    <>
      ...
      <style>{`
        ...
        .s2-title { font-weight: 800; letter-spacing: -0.03em; line-height: 1.08; font-size: var(--font-size-hero); margin: 0 auto 16px; max-width: 15ch; }
        ...
        .s2-section-title { font-weight: 700; font-size: var(--font-size-page-title); letter-spacing: -0.02em; text-align: center; margin: 0 0 8px; }
        ...
        .s2-cta h2 { font-size: var(--font-size-page-title); font-weight: 700; margin: 0 0 10px; }
