...
const styles: Record<string, React.CSSProperties> = {
  ...
  card: { maxWidth: 460, width: '100%', padding: 'clamp(20px, 5vw, 28px)', borderRadius: 'var(--radius-lg)', border: '1px solid var(--border-subtle, #2a2f3a)', background: 'var(--bg-surface, #11151f)' },
  h1: { margin: '0 0 12px', fontSize: 22, color: 'var(--text-primary, var(--text-primary))' },
  ...
  keyBox: { padding: '12px 14px', margin: '0 0 14px', borderRadius: 'var(--radius-md)', background: 'var(--bg-deep, #0b1220)', border: '1px solid var(--border-subtle, #2a2f3a)', overflowWrap: 'anywhere' },
  keyText: { fontFamily: 'monospace', fontSize: 13, color: 'var(--text-primary, var(--text-primary))' },
  row: { display: 'flex', gap: 12, flexWrap: 'wrap' },
  primary: { padding: '10px 16px', minHeight: 44, borderRadius: 'var(--radius-md)', border: 'none', background: 'var(--accent, #ff6a3d)', color: 'var(--text-on-accent)', fontWeight: 600, cursor: 'pointer' },
  secondary: { padding: '10px 16px', minHeight: 44, borderRadius: 'var(--radius-md)', border: '1px solid var(--border-subtle, #2a2f3a)', background: 'transparent', color: 'var(--text-primary, var(--text-primary))', cursor: 'pointer' },
