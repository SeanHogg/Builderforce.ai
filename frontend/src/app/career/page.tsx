 ...
 * code. What it shows is the signed-in person's own document (a guest sees the sample
 * workspace), but the URL is a named destination the sitemap submits, so its head is the
 * destination's — see `routeTeaserMetadata`.
 */
export const runtime = 'edge';

export async function generateMetadata() {
  return routeTeaserMetadata('/career');
}
