...
import VisitorFlowPanel from '@/components/admin/panels/VisitorFlowPanel';
...
export default function AdminPage() {
  ...
  const allowed = hasSession(useRequireSession({ returnTo: '/admin', requireTenant: false }));
