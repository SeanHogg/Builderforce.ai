...
export default function CreationCanvasMarketingPage() {
  return <main className="ccm">
    <style>{`
      .ccm{max-width:var(--marketing-max);margin:auto;padding:72px var(--marketing-gutter) 96px;color:var(--text-primary);font-family:var(--font-sans)}
      .ccm-hero{text-align:center;margin:0 auto 64px}.ccm-kicker{color:var(--coral-bright);font-weight:750;letter-spacing:.12em;text-transform:uppercase;font-size:.76rem}.ccm h1{font:750 clamp(2.5rem,7vw,5.3rem)/.98 var(--font-sans);letter-spacing:-.055em;margin:18px 0}.ccm-hero p{max-width:760px;margin:0 auto 28px;color:var(--text-secondary);font-size:1.16rem;line-height:1.65}.ccm-actions{display:flex;justify-content:center;gap:12px;flex-wrap:wrap}.ccm-actions a{padding:13px 22px;border:1px solid var(--border-subtle);border-radius:var(--radius-lg);text-decoration:none;font-weight:700;color:var(--text-primary)}.ccm-actions a:first-child{background:var(--coral-bright);border-color:var(--coral-bright);color:var(--text-on-accent)}
      .ccm-board{position:relative;min-height:430px;margin:0 0 72px;border:1px solid var(--border-subtle);border-radius:var(--radius-xl);background-color:var(--surface-card);background-image:radial-gradient(var(--border-subtle) 1px,transparent 1px);background-size:24px 24px;overflow:hidden}.ccm-card{position:absolute;width:250px;padding:18px;border:1px solid var(--border-subtle);border-radius:var(--radius-lg);background:var(--surface-card);box-shadow:0 14px 38px rgba(27,53,86,.13)}.ccm-card b{display:block;margin-bottom:8px}.ccm-card span{color:var(--text-secondary);font-size:.86rem;line-height:1.5}.ccm-card:nth-child(1){left:6%;top:13%}.ccm-card:nth-child(2){left:39%;top:8%;width:300px}.ccm-card:nth-child(3){right:5%;top:18%}.ccm-card:nth-child(4){left:23%;bottom:10%}.ccm-card:nth-child(5){right:20%;bottom:8%}
      .ccm h2{font:750 clamp(1.7rem,4vw,2.6rem)/1.1 var(--font-sans);letter-spacing:-.035em;margin:64px 0 24px}.ccm-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px}.ccm-feature{padding:22px;border:1px solid var(--border-subtle);border-radius:var(--radius-xl);background:var(--surface-card)}.ccm-feature h3{margin:0 0 8px;font-size:1rem}.ccm-feature p{margin:0;color:var(--text-secondary);font-size:.9rem;line-height:1.6}.ccm-specs{border:1px solid var(--border-subtle);border-radius:var(--radius-xl);overflow:hidden}.ccm-spec{display:grid;grid-template-columns:190px 1fr;gap:20px;padding:16px 20px;border-bottom:1px solid var(--border-subtle)}.ccm-spec:last-child{border:0}.ccm-spec b{font-size:.9rem}.ccm-spec span{color:var(--text-secondary);line-height:1.55;font-size:.9rem}
    ...
    <section className="ccm-board" aria-label="Example Creation Canvas"><div className="ccm-card"><b>⌘ Campaign workflow</b><span>Audience → Create → Approve → Publish</span></div><div className="ccm-card"><b><Icon source="◎" size="1em" /> Interactive landing page</b><span>Live WYSIWYG website prototype</span></div><div className="ccm-card"><b><Icon source="▥" size="1em" /> Campaign forecast</b><span>Dataset-bound funnel and channel metrics</span></div><div className="ccm-card"><b><Icon source="●" size="1em" /> Brain conversation</b><span>Will this workflow be effective with this page?</span></div><div className="ccm-card"><b><Icon source="✦" size="1em" /> Campaign strategist</b><span>Live agent · configured and assignable</span></div></section>
