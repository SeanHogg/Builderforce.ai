...
/**
 * Single nav for /agents/* pages. Decides its own active-link state from
 ...
 */
const NEXT_LINKS = [
  { label: 'Showcase', href: '/agents/showcase' },
  { label: 'Integrations', href: '/agents/integrations' },
  { label: 'Skills', href: '/agents/skills' },
  { label: 'Shoutouts', href: '/agents/shoutouts' },
] as const;
  ...
  return (
    <header className="cc-nav">
      <div className="cc-nav-inner">
        <Link href="/agents" className="cc-nav-logo">
          <Image
            src="/agents.png"
