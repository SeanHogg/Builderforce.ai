...
export const metadata: Metadata = {
  title: 'Integrations — BuilderForce Agents',
  description:
    'BuilderForce Agents integrates with your entire stack — WhatsApp, Telegram, Discord, GitHub, Gmail, Obsidian, and more. Connect your agents to the tools you already use.',
