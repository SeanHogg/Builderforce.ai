  ...
  return (
    <>
      ...
      <style>{`
        ...
        .intg-eyebrow { font-family: var(--font-display); font-size: var(--font-size-small); font-weight: 600; letter-spacing: 0.16em; text-transform: uppercase; color: var(--coral-bright); margin-bottom: 14px; }
        .intg-title { font-family: var(--font-display); font-weight: 700; letter-spacing: -0.03em; line-height: 1.1; font-size: var(--font-size-hero); color: var(--text-primary); margin: 0 0 14px; }
        .intg-tagline { font-size: var(--font-size-lede); color: var(--text-primary); font-weight: 600; margin: 0 0 12px; }
        .intg-sub { font-size: var(--font-size-lede); color: var(--text-secondary); line-height: 1.7; margin: 0; }
        ...
        .intg-h2 { font-family: var(--font-display); font-weight: 700; font-size: var(--font-size-section); color: var(--text-primary); margin: 22px 0 12px; }
        ...
        .intg-use { background: var(--surface-card); border: 1px solid var(--border-subtle); border-radius: var(--radius-lg); padding: 16px 18px; color: var(--text-primary); font-size: var(--font-size-body); line-height: 1.5; }
