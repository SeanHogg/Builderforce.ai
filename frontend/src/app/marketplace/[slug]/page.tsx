  ...
  return (
    <>
      ...
      <style>{`
        ...
        .mps-eyebrow { font-family: var(--font-display); font-size: var(--font-size-small); font-weight: 600; letter-spacing: 0.16em; text-transform: uppercase; color: var(--coral-bright); margin-bottom: 12px; }
        .mps-title { font-family: var(--font-display); font-weight: 700; letter-spacing: -0.03em; line-height: 1.1; font-size: var(--font-size-hero); color: var(--text-primary); margin: 0 0 12px; }
