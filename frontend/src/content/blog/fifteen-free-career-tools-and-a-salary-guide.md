...
```bf-figure
{
  ...
  "bands": [
    { "label": "Score against an ATS", "note": "What a screening system can and cannot extract from your file, and which sections it loses.", "hue": "market" },
    { "label": "Match to one posting", "note": "Your evidence against the requirements THIS employer wrote, not a generic rubric.", "hue": "market" },
...
```bf-figure
{
  ...
  "rows": [
    ...
    { "label": "Addresses in the guide", "value": 240, "note": "240", "hue": "market" }
  ],
...
```bf-figure
{
  ...
  "columns": [
    ...
    { "title": "Objects on a board", "hue": "market", "items": ["Applications, postings, interviews, variants", "Connected to each other", "Countable — how many are waiting on me?", "Alerts that use the same rules as the search"] }
  ],
