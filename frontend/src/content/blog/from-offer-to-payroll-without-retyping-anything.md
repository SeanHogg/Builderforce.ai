...
```bf-figure
{
  ...
  "steps": [
    { "label": "Signed offer", "note": "The trigger. Not an accepted verbal, not an offer at draft — a signed one.", "hue": "market" },
...
```bf-figure
{
  ...
  "bands": [
    ...
    { "label": "Greenhouse", "note": "The ATS side — candidates and pipelines, read alongside the people they become.", "hue": "market" },
