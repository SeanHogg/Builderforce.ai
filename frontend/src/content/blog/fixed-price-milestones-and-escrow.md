...
```bf-figure
{
  ...
  "steps": [
    { "label": "Fund", "note": "The client commits the amount. Until this happens the milestone is not startable — the whole point of the arrangement.", "hue": "market", "tag": "client" },
