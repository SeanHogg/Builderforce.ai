...
```bf-figure
{
  ...
  "steps": [
    ...
    { "label": "Chase", "note": "One rung of a collections ladder, recorded once per step — so the same customer is never chased twice for the same thing.", "hue": "market" },
...
```bf-figure
{
  ...
  "bands": [
    ...
    { "label": "The deal", "note": "Quotes, trials, mutual action plans — what is being sold, connected to what it sells.", "hue": "market" },
