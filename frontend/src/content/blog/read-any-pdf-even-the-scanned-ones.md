...
```bf-figure
{
  ...
  "bands": [
    { "label": "A résumé", "note": "Dropped as a PDF or a Word file, read directly, and restyled through the template engine — no third-party parse account, no retyping.", "hue": "market" },
