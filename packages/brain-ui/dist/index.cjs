...
function ChatTicketsPanelInner({ chatId, projectId, chatList, adapter, labels, onChanged, refreshSignal, visibility, onSetVisibility, onOpenTicket }) {
  ...
  const agg = (0, import_react6.useMemo)(() => {
...
function EvermindAnalyzer({ t, disabled, onAnalyze, onApply, onRepaired, analysis, onAnalysis }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { style: sectionBlock, children: [
    ...
    analysis?.truncated && typeof analysis.total === "number" && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("p", { style: italic, children: t.analyzeCoverage(analysis.analyzed, analysis.total) }),
...
function EvermindConsole({ adapter, canManage, labels, refreshMs = 2e4, projectName, showRecent = true, showHeaderRefresh = true, refreshSignal, onValidate, host = "web" }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(Section, { "aria-label": t.title, children: [
    ...
    notice && /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("p", { style: { margin: 0, fontSize: "0.74rem", lineHeight: 1.5, color: noticeTone === "warn" ? C.warnText : C.accent }, role: "status", children: notice }),
...
function TeachBox({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { style: sectionBlock, children: [
    ...
    teaching ? /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("textarea", { value: prompt, onChange: (e) => onPrompt(e.target.value), disabled: busy, placeholder: t.teachTaskPlaceholder, rows: 3, style: { ...select, width: "100%", resize: "vertical", fontFamily: "inherit" } }) : /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(import_jsx_runtime17.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("textarea", { value: text, onChange: (e) => onText(e.target.value), disabled: busy, placeholder: t.teachTextPlaceholder, rows: 3, style: { ...select, width: "100%", resize: "vertical", fontFamily: "inherit" } })
    ] }),
