      ...
      nodes.map((node) => {
        ...
        if (node.kind === "learn") {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("li", { className: "bf-tl__item bf-tl__item--memory", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "bf-tl__body", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "bf-tl__memory-line", title: labels.learnHint, children: title }) })
          ] }, node.key);
        }
...
function ChatTicketsPanelInner({ chatId, projectId, chatList, adapter, labels, onChanged, refreshSignal, visibility, onSetVisibility }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: S.root, children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { style: { display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }, children: tickets.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: S.muted, children: labels.none }) : tickets.map((tk) => {
      const key = `${tk.kind}:${tk.ref}`;
...
function EvermindConsole({ adapter, canManage, labels, refreshMs = 2e4, projectName, showRecent = true, onValidate }) {
  ...
  const Header = /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("header", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { type: "button", onClick: () => void reload(), disabled: busy, style: ghostBtn, title: t.refresh, "aria-label": t.refresh, children: "\u21BB" })
  ] });
  if (loadFailed) {
