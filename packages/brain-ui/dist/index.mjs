...
function SeedControls({
  ...
  return /* @__PURE__ */ jsxs8("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
    ...
    /* @__PURE__ */ jsxs8("div", { style: { display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }, children: [
      /* @__PURE__ */ jsx8("select", { value: selectedSlug, onChange: (e) => onSelect(e.target.value), disabled: busy, style: { ...select, flex: "1 1 200px" }, children: models.map((m) => /* @__PURE__ */ jsx8("option", { value: m.slug, children: m.name }, m.slug)) }),
...
function TeacherPicker({
  ...
  return /* @__PURE__ */ jsxs8("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: [
    ...
    !canManage ? /* @__PURE__ */ jsx8("div", { style: { ...select, color: C.text2 }, children: value || t.teacherNone }) : opts && !opts.isPaid ? /* @__PURE__ */ jsx8("p", { style: italic, children: t.teacherPaidOnly }) : /* @__PURE__ */ jsxs8("select", { value, onChange: (e) => onChange(e.target.value), disabled: busy, "aria-label": t.teacherLabel, style: { ...select, maxWidth: 340 }, children: [
      /* @__PURE__ */ jsx8("option", { value: "", children: t.teacherNone }),
      options.map((m) => /* @__PURE__ */ jsx8("option", { value: m, children: m }, m))
    ] })
  ] });
}
function TeachBox({
  ...
  return /* @__PURE__ */ jsxs8("div", { style: { display: "flex", flexDirection: "column", gap: 6, borderTop: `1px solid ${C.border}`, paddingTop: 10 }, children: [
    /* @__PURE__ */ jsx8("div", { style: fieldTitle, children: t.teachTitle }),
    /* @__PURE__ */ jsx8("div", { style: fieldHint, children: t.teachHint }),
    ...
    /* @__PURE__ */ jsx8("div", { children: /* @__PURE__ */ jsx8("button", { type: "button", onClick: onTeach, disabled: busy || text.trim().length < 20, style: primaryBtn(busy || text.trim().length < 20), children: busy ? t.teaching : t.teachCta }) })
  ] });
}
function RecentList({ t, entries }) {
  return /* @__PURE__ */ jsxs8("div", { style: { display: "flex", flexDirection: "column", gap: 6, borderTop: `1px solid ${C.border}`, paddingTop: 10 }, children: [
    /* @__PURE__ */ jsx8("div", { style: fieldTitle, children: t.inspectTitle }),
    entries.length === 0 ? /* @__PURE__ */ jsx8("p", { style: italic, children: t.inspectEmpty }) : /* @__PURE__ */ jsx8("ul", { style: { listStyle: "none", margin: 0, padding: 0, display: "flex", flexDirection: "column", gap: 6 }, children: entries.map((e, i) => /* @__PURE__ */ jsx8(RecentRow, { t, entry: e }, `${e.version}-${e.at}-${i}`)) })
  ] });
}
