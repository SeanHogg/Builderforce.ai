...
function EvermindAnalyzer({ t, disabled, onAnalyze, onApply, onRepaired, analysis, onAnalysis }) {
  ...
  return /* @__PURE__ */ jsxs13("div", { style: sectionBlock, children: [
    ...
    /* @__PURE__ */ jsxs13("div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }, children: [
      ...
      findings.length > 0 && onApply && /* @__PURE__ */ jsxs13(Fragment3, { children: [
    ...
    analysis && findings.length > 0 && /* @__PURE__ */ jsxs13(Fragment3, { children: [
...
function EvermindDiagnostics({ t, disabled, copy }) {
  ...
  return /* @__PURE__ */ jsxs14("div", { style: sectionBlock, children: [
    ...
    revealed && report !== null && /* @__PURE__ */ jsxs14(Fragment4, { children: [
...
function EvermindConsole({ adapter, canManage, labels, refreshMs = 2e4, projectName, showRecent = true, showHeaderRefresh = true, refreshSignal, onValidate, host = "web" }) {
  ...
  if (data && seeded && !inherited) {
    ...
    tabs.push({
      ...
      content: /* @__PURE__ */ jsxs16(Fragment5, { children: [
        /* @__PURE__ */ jsx16(
          TeacherPicker,
          {
            t,
...
function TeachBox({
  ...
  return /* @__PURE__ */ jsxs16("div", { style: sectionBlock, children: [
    ...
    teaching ? /* @__PURE__ */ jsx16("textarea", { value: prompt, onChange: (e) => onPrompt(e.target.value), disabled: busy, placeholder: t.teachTaskPlaceholder, rows: 3, style: { ...select, width: "100%", resize: "vertical", fontFamily: "inherit" } }) : /* @__PURE__ */ jsxs16(Fragment5, { children: [
      ...
      /* @__PURE__ */ jsx16("textarea", { value: text2, onChange: (e) => onText(e.target.value), disabled: busy, placeholder: t.teachTextPlaceholder, rows: 3, style: { ...select, width: "100%", resize: "vertical", fontFamily: "inherit" } })
    ] }),
...
${lines}`
  ...
  return /* @__PURE__ */ jsxs18("div", { className: "bf-360", children: [
    ...
    hasData && /* @__PURE__ */ jsxs18(Fragment6, { children: [
