...
__export(src_exports, {
  ClientCloneProvider: () => ClientCloneProvider,
  FallbackVoiceProvider: () => FallbackVoiceProvider,
  ServerCloneProvider: () => ServerCloneProvider,
  VoiceApiError: () => VoiceApiError,
  VoiceClient: () => VoiceClient,
  getEngineUnavailableReason: () => getEngineUnavailableReason,
  isEntitlementError: () => isEntitlementError,
  resolveNarrationEngine: () => resolveNarrationEngine
});
