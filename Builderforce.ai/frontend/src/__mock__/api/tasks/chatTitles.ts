...
export function generateChatTitle(
  ...
  // Use either (1) top N chronological messages OR (2) all up to a character limit,
  // matching the PRD's "first few messages or a specified character count" guidance.
  ...
  // Return immediately with likely plausible titles; do not wait.
