...
本指南总结了在 BuilderForce Agents 中开发 Pi 集成的合理工作流程。
...
状态存储在 BuilderForce Agents 状态目录下。默认为 `~/.builderforce`。如果设置了 `BUILDERFORCE_AGENTS_STATE_DIR`，则使用该目录。

要重置所有内容：

- `builderforce.json` 用于配置
...
- https://builderforce.ai/docs/help/testing
