...
- 生成的 Swift 模型：`apps/macos/Sources/BuilderForce AgentsProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/SeanHogg/Builderforce.ai/main/dist/protocol.schema.json
