...
BuilderForce Agents 可以使用 Perplexity Sonar 作为 `web_search` 工具。你可以通过 Perplexity 的直连 API 或通过 OpenRouter 连接。
...
如果未设置 base URL，BuilderForce Agents 会根据 API 密钥来源选择默认值：
