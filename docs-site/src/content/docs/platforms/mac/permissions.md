...
- Same path: run the app from a fixed location (for BuilderForce Agents, `dist/BuilderForce Agents.app`).
...
Workaround: move files into the BuilderForce Agents workspace (`~/.builderforce/workspace`) if you want to avoid per-folder grants.
