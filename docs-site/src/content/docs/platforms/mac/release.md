---
summary: "BuilderForce Agents macOS release checklist (Sparkle feed, packaging, signing)"
read_when:
  - Cutting or validating a BuilderForce Agents macOS release
  - Updating the Sparkle appcast or feed assets
title: "macOS Release"
---

# BuilderForce Agents macOS release (Sparkle)
...
- Notary credentials (keychain profile or API key) for `xcrun notarytool` if you want Gatekeeper-safe DMG/zip distribution.
  - We use a Keychain profile named `builderforce-notary`, created from App Store Connect API key env vars in your shell profile:
