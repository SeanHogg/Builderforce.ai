---
summary: "Overview of BuilderForce Agents: self-healing AI engineering agent and orchestration platform with persistent memory, self-repair, human-in-the-loop governance, and multi-channel messaging"
read_when:
  - Learning what BuilderForce Agents is and what it does
  - Deciding if BuilderForce Agents fits your use case
  - Understanding which features are available
title: "BuilderForce Agents Overview"
---

# BuilderForce Agents Overview

BuilderForce Agents is a **self-hosted, open-source AI coding assistant** that connects your favorite messaging apps to powerful AI agents. Run it on your own infrastructure — no cloud lock-in, no data leaving your control.
...
**BuilderForce Agents** connects messaging apps (WhatsApp, Telegram, Discord, Slack, and more) to AI coding agents with a secure, extensible gateway.
...
**BuilderForce AgentsLLM** — a pay-per-use API layer for AI agent compute — is included for teams who need managed model access without managing their own provider keys.
...
BuilderForce Agents includes enterprise-grade capabilities for teams that need more:
...
- 💰 **BuilderForce AgentsLLM** - Pay-per-use API layer for AI agent compute
...
| BuilderForce AgentsLLM compute API                   | ❌       | ✅          |
...
### BuilderForce Agents with Enterprise Runtime
...
└─────────────┬───────────────────────┘
              ...
              ▼
┌─────────────────────────────────────┐
│     BuilderForce Agents Runtime Layer         │
│  ┌───────────────────────────────┐  │
...
✅ BuilderForce AgentsLLM provides pay-per-use compute without managing provider keys
...
BuilderForce Agents is **MIT licensed** and **free to use**.

- Source: [github.com/SeanHogg/Builderforce.ai](https://github.com/SeanHogg/Builderforce.ai)
...
Documentation: [docs.builderforce.ai](https://builderforce.ai/docs)
...
BuilderForce Agents welcomes contributions:
...
**Q: Can I run BuilderForce Agents on the same machine as other services?**

A: Yes, just ensure the gateway port (18789) is not in use by another process.

**Q: Is BuilderForce Agents expensive to run?**
...
A: Yes. Backup your `~/.builderforce` directory to preserve your configuration.
...
**BuilderForce Agents** = Self-hosted, open-source AI coding assistant + multi-channel messaging gateway + self-healing multi-agent orchestration platform.
...
_This guide is maintained by the BuilderForce Agents project. For questions, see [docs.builderforce.ai](https://builderforce.ai/docs)._
