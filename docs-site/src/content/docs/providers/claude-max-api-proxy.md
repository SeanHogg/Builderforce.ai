...
You can point BuilderForce Agents at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or BuilderForce Agents
...
- [Anthropic provider](/providers/anthropic) - Native BuilderForce Agents integration with Claude setup-token or API keys
