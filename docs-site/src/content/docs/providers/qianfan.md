---
summary: "Use Qianfan's unified API to access many models in BuilderForce Agents"
read_when:
...
3. BuilderForce Agents installed on your system
...
4. Copy the API key for use with BuilderForce Agents

## CLI setup

```bash
builderforce onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [BuilderForce Agents Configuration](/gateway/configuration)
