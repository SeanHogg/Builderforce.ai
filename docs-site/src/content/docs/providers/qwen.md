---
summary: "Use Qwen OAuth (free tier) in BuilderForce Agents"
read_when:
  - You want to use Qwen with BuilderForce Agents
...
If you already logged in with the Qwen Code CLI, BuilderForce Agents will sync credentials
