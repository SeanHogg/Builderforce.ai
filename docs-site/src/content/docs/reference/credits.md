...
- **Peter Steinberger** ([@steipete](https://x.com/steipete)) - Creator, agent wrangler
- **Mario Zechner** ([@badlogicc](https://x.com/badlogicgames)) - Pi creator, security pen tester
- **BuilderForce Agents** - The agent that demanded a better name
...
MIT - Free as an agent on the network.
