...
BuilderForce Agents treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.builderforce/settings/voicewake.json`

Shape:

```json
{ "triggers": ["builderforce", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
