...
BuilderForce Agents treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.

## Beginner intro (2 minutes)

BuilderForce Agents “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, BuilderForce Agents can see that group and respond there.
...
Translation: allowlisted senders can trigger BuilderForce Agents by mentioning it.
